            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th class="border px-6 py-4">Img</th>
                        ...
                        @forelse($food as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4">
                                    <img src="{{ $item->picturePath }}" alt="" width="150" height="150">
                                </td>
                                <td class="border px-6 py- text-center">
                                    ...
                                    <form action="{{ route('food.destroy', $item->id) }}" method="POST" class="inline-block">
                                        ...
                                        <button type="submit" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 mx-2 rounded inline-block" onclick="return confirm('Delete Food?')">
                                            Delete
                                        </button>
                                    </form>
                                </td>
